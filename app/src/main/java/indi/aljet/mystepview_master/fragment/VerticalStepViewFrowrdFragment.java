package indi.aljet.mystepview_master.fragment;
...
import indi.aljet.mystepview_master.stepview.VerticalStepView;

public class VerticalStepViewFrowrdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        mView = View.inflate(getActivity(),
                R.layout.fragment_vertical_stepview,null);
        return mView;
    }
    ...
    public void onStart() {
        super.onStart();
        mStepView0 = mView.findViewById(R.id.step_view0);
        ...
        mStepView0.setStepsViewIndicatorComplectingPosition(list0.size() - 2)//设置完成的步数
